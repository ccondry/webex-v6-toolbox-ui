<template>
  <div class="tile is-parent" style="max-width: 32rem;">
    ...
    >
      ...
      <p>
        Upload a logo image to automatically replace the background in your current
        desktop layout.
      </p>
    ...
    upload ({
      ...
      if (validTypes.includes(mime)) {
        this.$buefy.dialog.confirm({
          message: 'Are you sure you want to replace the background image in your desktop layout?',
          rounded: true,
          confirmText: 'Yes',
          type: 'is-success',
          onConfirm: () => {
